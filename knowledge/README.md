...
| spec/ | parametros.yaml (F02, ADR-0002/0004: LA puerta de los parametros; el recuento vivo lo da `botsito spec status`; no se pega aqui), ambiguedades.yaml (F10, ADR-0011: las preguntas abiertas, legibles por maquina), strategy_spec.yaml y glossary.yaml (F11) | versionado; cada commit cita `Fuente:` (evidence-id, feedback-id o ADR) |
