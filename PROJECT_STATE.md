...
| A-20 | cuantas zonas de control invalidan un esquema | F12, F20, F26 | RN-009 dice "mas de una zona" pero el literal dice "por lo general solo buscamos uno": ¿regla o tendencia? |
...
## Next Action
1. RECIBIR DEL TRADER el backtest COMPLETO de mayo y junio de 2026 con el Excel (decision, hora, entrada, SL y TP por operacion): se comprometio a enviarlo antes del sabado 2026-09-12 (v6 2:26:12). Sustituye al etiquetado a mano de los 16 dias `dev`; son 40 casos sobre meses que NO ha visto. Ojo al matiz: los hara aplicando las reglas acordadas, asi que sirven de patron oro para medir al bot pero ya no miden si esas reglas capturan su juicio espontaneo. Mayo y junio caen FUERA de los 28 dias de desfase de horario, asi que la auditoria no cambia lo que tiene que enviar.
2. PREGUNTARLE POR ESCRITO dos cosas cortas que cierran dos ambiguedades sin gastar sesion: A-14 (del 8 al 28 de marzo y del 25 al 31 de octubre la primera H4 le abre a las 22:00 y sus sesiones dejan de empezar en apertura de vela: ¿opera igual o se ajusta a la vela?) y A-11 (el SL del calculo del lotaje, ¿lo deja puesto en la orden limite o lo pone tras el llenado?).
3. CERRAR LA REVISION DE DISENO DE F12 (D1..D4 del brief) antes de programar nada.
