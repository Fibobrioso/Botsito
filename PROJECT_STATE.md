...
| A-21 | que ES un breaker y que ES el segundo esquema de entrada | F12, F20, F26 | el corpus nunca lo define: el glosario es circular y la cita dice "el que ya sabemos cual es". BLOQUEANTE para el motor |
