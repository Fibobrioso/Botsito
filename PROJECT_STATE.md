...
## Next Feature
F10 · elicitation-kit (orden E: F08 -> F10 + sesion 1 con el trader). Entradas: 341 items de evidencia con `kb find`/`kb at` (F08), ambiguedades A-1..A-12 con ids, contradiccion `stop.nivel`, parametros UNKNOWN del registro, datasets OHLC de F15 (ene/jul/ago 2026), fotogramas y crudas. F10 absorbe: parametros UNKNOWN
