...
- F11 strategy-spec-schema (2026-09-09; auditada el 2026-09-10): `feedback apply`, registro con 54 parametros (46 confirmados, 2 con default nuestro, 6 UNKNOWN a proposito), 27 reglas de spec (24 vigentes), glosario de 8 terminos, manifiesto 2.0.0 con hash sobre los tres ficheros, `spec status`, ADR-0012 a ADR-0016. Informe en `docs/validation/F11-strategy-spec-schema.md`, con la tabla P1..P11 de la auditoria.
## Existing Components
...
| A-14 | el reloj del grafico fuera del horario de verano | F11, F15 | ¿UTC+2 fijo, Madrid, o el servidor del broker (GMT+2/+3, calendario de Nueva York)? Las tres coinciden en verano, que es cuando se leyo (v3 0:01:36, v6 0:58:10) |
