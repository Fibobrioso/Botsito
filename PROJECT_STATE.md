...
## Current Feature
F08 · evidence-retrieval · EN CONSTRUCCION (rama `feature/F08-evidence-retrieval`; brief `docs/plan/features/F08-evidence-retrieval.md` con revision de diseno aplicada; ADR-0010)
