...
- F11 strategy-spec-schema (2026-09-09): `feedback apply` con 32 parametros escritos, registro con 42 parametros (36 con valor), 25 reglas de spec, glosario, manifiesto con hash sobre los tres ficheros, `spec status`, ADR-0012 y ADR-0013. Informe en `docs/validation/F11-strategy-spec-schema.md`. make check verde (601 casos).
## Existing Components
