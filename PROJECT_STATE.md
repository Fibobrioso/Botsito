...
## Next Feature
Sesion 1 con el trader (registros F09: confirmacion escrita de que no ha visto mayo/junio de 2026, las 3 preguntas bloqueantes A-2/A-4/A-9 con captura del grafico, el resto de `hoja_trader.md`, etiquetado de los 16 casos `dev` por sesion H4) y despues F11 strategy-spec-schema (reglas con parametros ya nombrados y ambiguedades resueltas). Golden H4 contra la captura del trader (test de regresion sobre F15): se escribe en F11 al fijar `anclaje_h4` con la captura de P-03.
