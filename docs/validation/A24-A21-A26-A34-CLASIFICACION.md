...
| 5 | v3 | 0:11:19-0:14:19 | no responde · **DUDA** | #142-#145 «como es un retroceso complejo, estaríamos marcando lo que sería / en este complex pullback alcista, / que yo no suelo usar el término higher, bueno, higher hike, / hay pero el alto más alto aquí alto más alto sería la liquidez esto es en m15 temporalidad de m15 ya» | Apunta a (b), pero sobre un croquis, y **en ese dibujo (a) y (b) señalan el mismo pivote**. Lo dice la nota de A-24 en `ambiguedades.yaml`, medida en pantalla antes de esta rama: «El item de v3 0:12:42 (complex pullback, "el alto mas alto") se mide sobre un CROQUIS A MANO en un grafico de 1h -fr-v3-982da728/781000-, y en ese dibujo el alto mas alto es ademas el ultimo: no sostiene un criterio distinto, solo el mismo en otro ejemplo». *Corregido el 2026-09-24 en esta misma rama, antes del merge: esta fila decía que el fotograma no se había abierto, y ya estaba medido.* |
...
- **A-24.**
  ...
  - El 5 apunta a (b), en un croquis de retroceso complejo en el que, medido en pantalla (`fr-v3-982da728/781000`), el alto más alto es además el último: (a) y (b) señalan el mismo pivote.
