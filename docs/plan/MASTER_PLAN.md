...
|---|---|---|---|
| Sesion 1 (tras F10 + F15) | 3 preguntas bloqueantes sobre casos: A-2, A-4 y A-9 (con captura del grafico), P-01..P-03 de `hoja_trader.md` (F10; ver mapeo en `PROJECT_STATE.md`, Known Ambiguities); ronda 1 de etiquetado; hoja de reglas | FeedbackRecord | spec (F11), casos dev/holdout |
