...
`feedback apply|pending` y `spec status|manifest` (F11), `spec check` (la capa semantica de la
spec, F12), `spec docs` (genera `docs/spec/`) y `kit hoja` (la hoja de la sesion en Word, F13);
